    ...
    model(0)
{
    ...
    ui->addressIn_SM->setPlaceholderText(tr("Enter a CateDoge address (e.g. SPf1FRfmnpKSWA6bNZ6pV9mt8mCeyL2STQ)"));
    ui->pubkeyOut_VM->setPlaceholderText(tr("Click \"Sign Message\" to view public key"));
    ui->signatureOut_SM->setPlaceholderText(tr("Click \"Sign Message\" to generate signature"));

    ui->addressIn_VM->setPlaceholderText(tr("Enter a CateDoge address (e.g. SA4FztWbWTJUD5CWXdfUQDocLSRjdBxwmA)"));
    ui->pubkeyIn_VM->setPlaceholderText(tr("Enter the public key used for signing"));
    ui->signatureIn_VM->setPlaceholderText(tr("Enter CateDoge signature"));
#endif
