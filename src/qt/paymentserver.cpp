...
const QString BITCOIN_IPC_PREFIX("CateDoge:");
...
{
    // Install global event filter to catch QFileOpenEvents on the mac (sent when you click CateDoge: links)
    ...
    if (!uriServer->listen(name))
        qDebug() << tr("Cannot start CateDoge: click-to-pay handler");
    else
...
{
    // clicking on CateDoge: URLs creates FileOpen events on the Mac:
