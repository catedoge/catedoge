...
// Copyright (c) 2014 The Catedoge developers
...
uint256 hashGenesisBlock("0x000000632c603a4a1e81fcf8416332c522bb59b1f1c193e823e6c35261614bdd");
static const unsigned int timeGenesisBlock = 1396723500;
static const unsigned int nNonceGenesisBlock = 12095872;
...
const string strMessageMagic = "Catedoge Signed Message:\n";
...
static const int64 nGenesisBlockRewardCoin = 10000 * COIN; // LOST SHIBES TO BE NEVER FOUND
static const int64 nInitialReward = 60000000 * COIN; // KEEP UP SERVERS AND NODES
static const int64 nBlockRewardStartCoin = 100000 * COIN;
static const int64 nMinSubsidy = 12500 * COIN;
...
int64 static GetBlockValue(int nHeight, int64 nFees, unsigned int nBits)
{
    ...
    // Subsidy is cut in half every 36000 blocks
    nSubsidy >>= (nHeight / 36000);
        ...
        for (unsigned int i = 1; BlockReading && BlockReading->nHeight > 0; i++) {
                ...
                PastDifficultyAveragePrev = PastDifficultyAverage;
                 ...
                 if (LatestBlockTime < BlockReading->GetBlockTime()) {
                       if (BlockReading->nHeight > 6000) // HARD Fork block number
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x00000067a8d3d861b2eedc41dc8761a70810d9a2b64dee4c5090678449fe9265");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        if (fTestNet)
        {
            block.nTime    = 1396724400;
            block.nNonce   = 8651056;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x28bb2925e776207030de4146c32be6dcfe0d8b2d0655cd8a14ca392176ded268"));
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xc0, 0xdb };
...
bool CheckWork(CBlock* pblock, CWallet& wallet, CReserveKey& reservekey)
{
    ...
    // Found a solution
    {
        ...
        if (pblock->hashPrevBlock != hashBestChain)
            return error("CatedogeMiner : generated block is stale");
        ...
        if (!ProcessBlock(state, NULL, pblock))
            return error("CatedogeMiner : ProcessBlock, block not accepted");
    }
...
{
    printf("CatedogeMiner started\n");
    SetThreadPriority(THREAD_PRIORITY_LOWEST);
    RenameThread("catedogecoin-miner");
    ...
    try { while(true) {
        ...
        printf("Running CatedogeMiner with %"PRIszu" transactions in block (%u bytes)\n", pblock->vtx.size(),
...
//            unsigned int nNonceFound;
    ...
    {
        printf("CatedogeMiner terminated\n");
        throw;
    }
}
