...
---------------------
	...
	cd src/
	make -f makefile.unix		# Headless CateDoge

See readme-qt.rst for instructions on building CateDoge-Qt, the graphical user interface.
...
---------------------
 ...
 libcrypto++ Cryptography      Provides implementations for cryptography in CateDoge
...
Notes
-----
The release is built with GCC and then `strip CateDoged` to strip the debug
...
Security
--------
To help make your CateDoge installation more secure by making certain attacks impossible to
...
* Non-executable Stack
    ...
    vulnerable buffers are found. By default, CateDoge should be built with a non-executable stack
